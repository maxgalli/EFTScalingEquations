...
### Additional notes
Changes with respect to the last [iteration](../CMS-prelim-SMEFT-topU3l_22_05_02) include:
- Propagator corrections included for production modes (those derived with SMEFTsim)
- Rivet routine fixed to correctly classify off-shell vector boson production